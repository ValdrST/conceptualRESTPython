...
(CASE (CASE ES.ULTIMO_CURSADO WHEN '' THEN '{}' ELSE ES.ULTIMO_CURSADO END - ES.REGISTRO) % 10)
WHEN 0 THEN
...
(CASE (SELECT 100 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND ES2.AVANCE>=100)
...
WHEN 1 THEN (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM01>ES2.AVANCE)
...
WHEN 2 THEN (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM02>ES2.AVANCE)
WHEN 1 THEN (SELECT COUNT(*) FROM ESTUDIA_SERIACION ES2 WHERE ES2.REGISTRO=ES.REGISTRO AND ES2.CREDITOS_CUBIERTOS>=ES.CREDITOS_CUBIERTOS AND ES2.PROMEDIO>ES.PROMEDIO AND ES2.CARRERA=ES.CARRERA)
...
WHEN 3 THEN (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM03>ES2.AVANCE)
WHEN 1 THEN (SELECT COUNT(*) FROM ESTUDIA_SERIACION ES2 WHERE ES2.REGISTRO=ES.REGISTRO AND ES2.CREDITOS_CUBIERTOS>=ES.CREDITOS_CUBIERTOS AND ES2.PROMEDIO>ES.PROMEDIO AND ES2.CARRERA=ES.CARRERA)
...
WHEN 4 THEN (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM04>ES2.AVANCE)
WHEN 1 THEN (SELECT COUNT(*) FROM ESTUDIA_SERIACION ES2 WHERE ES2.REGISTRO=ES.REGISTRO AND ES2.CREDITOS_CUBIERTOS>=ES.CREDITOS_CUBIERTOS AND ES2.PROMEDIO>ES.PROMEDIO AND ES2.CARRERA=ES.CARRERA)
...
WHEN 5 THEN (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM05>ES2.AVANCE)
WHEN 1 THEN (SELECT COUNT(*) FROM ESTUDIA_SERIACION ES2 WHERE ES2.REGISTRO=ES.REGISTRO AND ES2.CREDITOS_CUBIERTOS>=ES.CREDITOS_CUBIERTOS AND ES2.PROMEDIO>ES.PROMEDIO AND ES2.CARRERA=ES.CARRERA)
...
WHEN 6 THEN (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM06>ES2.AVANCE)
WHEN 1 THEN (SELECT COUNT(*) FROM ESTUDIA_SERIACION ES2 WHERE ES2.REGISTRO=ES.REGISTRO AND ES2.CREDITOS_CUBIERTOS>=ES.CREDITOS_CUBIERTOS AND ES2.PROMEDIO>ES.PROMEDIO AND ES2.CARRERA=ES.CARRERA)
...
WHEN 7 THEN (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM07>ES2.AVANCE)
WHEN 1 THEN (SELECT COUNT(*) FROM ESTUDIA_SERIACION ES2 WHERE ES2.REGISTRO=ES.REGISTRO AND ES2.CREDITOS_CUBIERTOS>=ES.CREDITOS_CUBIERTOS AND ES2.PROMEDIO>ES.PROMEDIO AND ES2.CARRERA=ES.CARRERA)
...
WHEN 8 THEN (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM08>ES2.AVANCE)
WHEN 1 THEN (SELECT COUNT(*) FROM ESTUDIA_SERIACION ES2 WHERE ES2.REGISTRO=ES.REGISTRO AND ES2.CREDITOS_CUBIERTOS>=ES.CREDITOS_CUBIERTOS AND ES2.PROMEDIO>ES.PROMEDIO AND ES2.CARRERA=ES.CARRERA)
...
WHEN 9 THEN (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM09>ES2.AVANCE)
WHEN 1 THEN (SELECT COUNT(*) FROM ESTUDIA_SERIACION ES2 WHERE ES2.REGISTRO=ES.REGISTRO AND ES2.CREDITOS_CUBIERTOS>=ES.CREDITOS_CUBIERTOS AND ES2.PROMEDIO>ES.PROMEDIO AND ES2.CARRERA=ES.CARRERA)
...
ELSE (CASE (SELECT 1 FROM ESTUDIA_SERIACION ES2 WHERE ES2.CUENTA_ID=ES.CUENTA_ID AND ES2.PLN=ES.PLN AND ES2.CARRERA=ES.CARRERA AND CCP.ASEM10>ES2.AVANCE)
WHEN 1 THEN (SELECT COUNT(*) FROM ESTUDIA_SERIACION ES2 WHERE ES2.REGISTRO=ES.REGISTRO AND ES2.CREDITOS_CUBIERTOS>=ES.CREDITOS_CUBIERTOS AND ES2.PROMEDIO>ES.PROMEDIO AND ES2.CARRERA=ES.CARRERA)
...
ON DAD.cuenta=RIGHT('000000000'+ES.CUENTA_ID,9)
